...
```markdown
标准图片 ![一条dog#100px](R-C.jpg)
设置图片大小(相对大小&绝对大小) ![一条dog#10%#50px](R-C.jpg)
设置图片对齐方式：
**左对齐+边框**
![一条dog#auto#100px#left#border](R-C.jpg)
**居中+边框+阴影**
![一条dog#auto#100px#center#B#shadow](R-C.jpg)
**右对齐+边框+阴影+圆角**
![一条dog#auto#100px#right#B#S#radius](R-C.jpg)
**浮动左对齐+边框+阴影+圆角**
![一条dog#auto#100px#float-left#B#S#R](R-C.jpg)
开心也是一天，不开心也是一天
这样就过了两天，汪
```
